...
export default function ProductGallery({ product }: { product: ProductCardProps }) {
  const [mainImage, setMainImage] = useState(product.image)

  // Generate additional images for the gallery
  const gallery = [
    product.image,
    "/https://i.ibb.co/7NVh68vc/arduino-giga.webp",
    "https://i.ibb.co/kgtX0Nq7/Arduino-uno.webp",
  ]
