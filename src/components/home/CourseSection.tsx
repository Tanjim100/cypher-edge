    ...
    <section id="courses" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-12 text-center">
          <Link href="#all-courses" className="inline-flex items-center justify-center rounded-md bg-black px-6 py-2.5 text-sm font-medium text-white shadow-lg hover:outline ">
            View More Courses
          </Link>
        </div>
      </div>
