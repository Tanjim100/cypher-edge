...
// import workImg1 from '../../../public/images/about/workImg1.avif'
  ...
  const communityEvents = [
    {
      ...
      image: 'https://i.ibb.co/HDdGSdx/pexels-mike-468229-1178684.jpg',
      date: '01-01-2025'
    },
    {
    ...
    <section className="py-20 bg-[#ddf4ff]">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-12 text-center">
          <Link href="#community" className="inline-flex items-center justify-center rounded-md bg-black px-6 py-2.5 text-sm font-medium text-white shadow-lg hover:outline ">
            View All Activities
          </Link>
        </div>
      </div>
