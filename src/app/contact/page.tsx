...
import roboImg from "../../../public/images/roboshop.webp"
                        ...
                        <BlurFade delay={0.5}>
                            <div className="bg-white p-6 md:p-8 rounded-lg">
                                ...
                                <p className="text-gray-600 text-sm md:text-base mb-3">
                                    Cypher is a robotics components and education store based in IT Business Incubator, CUET, Chittagong, Bangladesh. Est since 2024.
                                </p>
